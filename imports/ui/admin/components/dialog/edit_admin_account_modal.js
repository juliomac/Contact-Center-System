...
class EditAccountInfoModal extends React.Component {

    state = {
        username_state:'Mai Mom',
        email_state: 'maimom61@gmail.com',
        phone_number_state: '8349123',
        password: '',
        showPassword: false,
        validate_name:true,
        validate_email:true,
    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    <DialogTitle id="alert-dialog-title">{"Update Account Information"}</DialogTitle>
                    <DialogContent>
...
export default withStyles(styles)(EditAccountInfoModal);
